...
function cambiarFoto()
{
	...
	document.getElementsByTagName('img')[1].setAttribute('src',phineasyfer);
}
function cambiarFoto2()
{
	let perry = "imagenes/imagenPerry.webp"
	document.getElementsByTagName('img')[1].setAttribute('src',perry);
}
